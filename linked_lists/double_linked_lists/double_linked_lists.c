...
int insertElement(LIST *head, list_type val, int pos) { // inserts element 'val' in the pos-th position
...
list_type getElement(LIST *head, int pos) { // returns the 'val' of the element in the pos-th position
    LIST *ptr = head;
