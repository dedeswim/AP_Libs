//
// single_circle_linked_lists - single_circle_linked_lists.c
...
#include <stdio.h>
#include <stdlib.h>
#include "single_circle_linked_lists.h"
...
int removeElement(LIST *head, int pos) { // removes the pos-th element in the list
...
list_type getElement(LIST *head, int pos) { // gets the pos-th element in the list
    LIST *ptr = head;
